...
def lambda_handler(event, context):
    ...
    try:
        ...
        resp = bedrock.invoke_model(
            modelId="arn:aws:bedrock:eu-north-1:878553493637:inference-profile/eu.anthropic.claude-sonnet-4-5-20250929-v1:0",
        ...
        # Claude response: look inside "content"
